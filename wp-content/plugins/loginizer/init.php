...
define('LOGINIZER_VERSION', '1.7.8');
...
.exp{
	...
	<div class="postbox">
		...
		<?php
			...
			wp_enqueue_script('chartjs', LOGINIZER_URL.'/chart.js', array('jquery'), '3.0.0');
	...
	<div id="" class="postbox">
		...
		<table class="form-table">
			...
			<tr>
				...
				<td>
					<input type="number" min="1" max="10" size="20" value="<?php echo (!empty($_POST['limit_session']['count']) ? sanitize_text_field($_POST['limit_session']['count']) : (!empty($loginizer['limit_session']['count']) ? sanitize_text_field($loginizer['limit_session']['count']) : 1)); ?>" name="limit_session[count]" />
				</td>
			</tr>
			<tr>
			<tr>
